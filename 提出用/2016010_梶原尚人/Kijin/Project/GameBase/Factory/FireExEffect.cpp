...
FireExEffect::FireExEffect(ObjectManager& objectManager) :
	Factory{objectManager}
{
}

ObjectID FireExEffect::Create(ObjectID ownerID, const Vector3& pos, const Vector3& rot)
{
	...
	static_cast<Render&>(*modelRender).Load("Resource/Effect/FireEx.efkefc");
...
void FireExEffect::Destroy(ObjectID id)
{
