...
HitEffect::HitEffect(ObjectManager& objectManager):
	Factory{objectManager}
{
}

ObjectID HitEffect::Create(ObjectID ownerID, const Vector3& pos, const Vector3& rot)
{
	...
	static_cast<Render&>(*modelRender).Load("Resource/Effect/Hit.efkefc");
...
void HitEffect::Destroy(ObjectID id)
{
