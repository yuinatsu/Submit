...
MuzzleFlashEffect::MuzzleFlashEffect(ObjectManager& objectManager) :
	Factory{ objectManager }
{
}

ObjectID MuzzleFlashEffect::Create(ObjectID ownerID, const Vector3& pos, const Vector3& rot)
{
	...
	static_cast<Render&>(*modelRender).Load("Resource/Effect/MuzzleFlash.efkefc");
...
void MuzzleFlashEffect::Destroy(ObjectID id)
{
